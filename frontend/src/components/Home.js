  ...
  return (
    <Box h={"max-content"} verticalAlign="middle">
      <Flex direction="column" align="center" justify="center" minH="80vh">
        <Box textAlign="center">
          <Text fontSize={"7xl"} fontWeight={"bold"} fontFamily={"Work sans"}>
            <Box as="span" color="orange.300">YO</Box>
            <Box as="span" color="blue.1000">/</Box>
            <Box as="span" color="blue.400">chat</Box>
          </Text>
      ...
      <Text
        ...
        textAlign="center"
      >
        &copy; 2025 YO/chat. All rights reserved.
        <Link to="https://github.com/DiveshPandey123" target="_blank">
